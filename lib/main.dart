...
import 'package:flutter_good_ui/navigator/navigator.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            MyClickButton(title: My3DSphere.name),
          ],
        ),
      ),
    );
...
class MyClickButton extends StatefulWidget {
  final String title;
  const MyClickButton({Key? key, required this.title}) : super(key: key);
